...
function setFieldFromCookie(cookie,fieldId){
    var cookieVal = cookie.getSubValue(fieldId);
    if( cookieVal ){
        var cmp = Ext.getCmp(fieldId);
        if(cmp.getXType()=='combo'){
            Ext.getCmp(fieldId).setValue(cookieVal);
            Ext.getCmp(fieldId).setRawValue(cookieVal);
        }else{
            Ext.getCmp(fieldId).setValue(cookieVal);
        }
    }
...
function saveFieldToCookie(cookie,fieldId){
    var cmp = Ext.getCmp(fieldId);
    var fieldVal = cmp.getValue();
    cookie.setSubValue(fieldId, fieldVal);
}